...
window.onload=function() {
  ...
  game.items = [ {price: 100, description:"Dagger", id: 0},
               {price : 500, description:"Cursed Drg. Paw", id: 1},
               {price : 5000, description:"Winter's Heart", id: 2},
...
function setMaps() {
  ...
  for (var i=0; i<foregroundData.length; i++) {
    ...
    for(var j=0; j<foregroundData[0].length;j++) {
      if (foregroundData[i][j] == 2 || foregroundData[i][j] == 4 ||foregroundData[i][j] == 15 ) {
        var collision = 1;
