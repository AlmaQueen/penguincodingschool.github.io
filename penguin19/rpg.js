...
window.onload=function() {
  ...
  game.items = [{price: 10000, description: "Destruction Knife", id: 0},{price: 10000, description: "Killing Hand", id: 1},{price:10000, description: "Icy Killing Magic", id: 2},{price: 10000, description: "Chess board", id: 3}];
  var map = new Map(game.spriteWidth, game.spriteHeight);
  var foregroundMap = new Map(game.spriteWidth, game.spriteHeight);
  
  var backgroundmusic = new Audio('Trap Music 2017 ☢ Bass Boosted Best Trap Mix | Car Music.mp3');
...
function setPlayer() {
  ...
  player.name = "ItzJustLuck YT";
 player.charClass = "";
  player.exp = 0;
  player.level=1;
  player.gold = ;
  player.hp = 100;
  player.maxHp =100;
  player.attack=10;
...
var meanguy = {
  action: function() {
    npc.say("Chess is a game u might want to play ItzJustLuck YT")
  }
};
...
var spriteRoles = [,,meanguy,,cat,,,,,,,,,,,randomdude];
...
var setBattle = function(){
  ...
  battle.actions = [
    ...
    {name: "Magic", action:function(){
      ...
      battle.menu.text =  "magic spells are awesome and you have some magic spellllls";
      battle.wait = true;
      battle.magicAttack();
      battle.activeAction = 0;
      setTimeout(function(){
...
var setShopping = function(){
    ...
    shop.greeting = "Konichiwa I am cat, and this shop is where you can buy stuff for free to defeat meanguy and randomdude";
    shop.apology = "U JUST GOT WRECKED!!!!";
    shop.sale = "Enjoy your little weapons";
    shop.farewell = "Adios,Come again! Meow!";
